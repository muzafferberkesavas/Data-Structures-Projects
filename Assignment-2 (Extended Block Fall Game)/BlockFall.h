...
public:
    ...
    void rotate(vector<vector<bool>> &shape, Block* block);
    void nextBlock(vector<vector<vector<bool>>>&Blocks,Block* block,int index);
    vector<vector<bool>> leftRotation(const vector<vector<bool>>& currentShape);
